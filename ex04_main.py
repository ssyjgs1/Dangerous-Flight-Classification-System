...
def main():    
    ...
    # model3.fc = nn.Linear(in_features= 512, out_features=2)
    # model3.to(device)
    ...
    # model5.fc = nn.Linear(in_features= 4096, out_features= 2)
    # model5.to(device)

    # model6 = rexnetv1.ReXNetV1()
    # model6.load_state_dict(torch.load("./rexnetv1_1.0.pth"))
    # model6.output[1] = nn.Conv2d(1280, 2, kernel_size=1, stride=1)
    # model6.to(device)
